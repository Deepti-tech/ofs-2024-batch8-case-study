...
public Customer(int customer_id, String first_name, String last_name, String approval_status, int login_attempts, String date_of_birth, String registration_date, String email_id,
